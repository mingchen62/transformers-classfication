...
# loading parameters, it shall look like  
'''
args = {
    'data_dir': 'data/',
    'model_type':  'xlnet',
...
if len(sys.argv) > 1:
    ...
    print("To use own config file: python " +sys.args[0] +" <config file")
    exit(0)
print("using config "+args_json)
...
if __name__ == '__main__':
    ...
    print("training completed "+str(time.time()-start_t))
    ...
    print("evaluation completed "+str(time.time()-start_t))
    print(results)
